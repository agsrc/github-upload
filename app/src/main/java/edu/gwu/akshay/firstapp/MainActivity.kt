package edu.gwu.akshay.firstapp
...
import edu.gwu.akshay.firstapp.R.id.time_left_text_view
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        timeLeft=findViewById<TextView>(R.id.time_left_text_view)
        gameScoreTextView.text=getString(R.string.your_score, score.toString())//study the methods of these line
